...
import com.arealapps.ultimatecheckers.gameCore.game_core.checkers_game.exceptions.GameException;
...
public class CheckersGameState implements GameState<CheckersMove> {
    ...
    private void createPossibleMoves() {
        for (Tile tile : checkersGame.getAvailablePieces()) {
            for (com.arealapps.ultimatecheckers.gameCore.game_core.checkers_game.structs.Move checkersMove : checkersGame.getAvailableMovesForPiece(tile.x, tile.y)) {
