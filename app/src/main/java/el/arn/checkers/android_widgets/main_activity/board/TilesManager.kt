package el.arn.checkers.android_widgets.main_activity.board
...
import el.arn.checkers.complementaries.IntIteratorWithRemainderCorrection
...
import el.arn.checkers.game.game_core.game_core.structs.Point
import el.arn.checkers.android_widgets.main_activity.board.parts.PlayableTile
import el.arn.checkers.android_widgets.main_activity.board.parts.Tile
import el.arn.checkers.android_widgets.main_activity.board.parts.UnplayableTile
...
//    private var currentlyHighlightedTilesForSelectedTile = mutableSetOf<Tile>()
    ...
    private fun createTileCoverForPassingTurn(tile: Tile) {
        ...
        image.setImageResource(R.drawable.crap_pass_turn_highlight)
