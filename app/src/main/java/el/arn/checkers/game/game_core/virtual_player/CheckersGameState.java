...
import el.arn.checkers.game.game_core.game_core.exceptions.GameException;
...
public class CheckersGameState implements GameState<CheckersMove> {
    ...
    private void createPossibleMoves() {
        for (Tile tile : checkersGame.getAvailablePieces()) {
            for (el.arn.checkers.game.game_core.game_core.structs.Move checkersMove : checkersGame.getAvailableMovesForPiece(tile.x, tile.y)) {
