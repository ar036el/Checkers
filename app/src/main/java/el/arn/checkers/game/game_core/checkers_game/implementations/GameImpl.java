...
import el.arn.checkers.game.game_core.checkers_game.*;
...
import el.arn.checkers.game.game_core.checkers_game.exceptions.*;
import el.arn.checkers.game.game_core.checkers_game.structs.*;
import el.arn.checkers.helpers.points.Point;

import java.util.*;
import static el.arn.checkers.game.game_core.checkers_game.configurations.GameLogicConfig.KingBehaviourOptions.*;
