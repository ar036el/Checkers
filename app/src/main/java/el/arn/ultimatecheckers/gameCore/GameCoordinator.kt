...
import el.arn.ultimatecheckers.gameCore.game_core.checkers_game.structs.*
import el.arn.ultimatecheckers.activityWidgets.mainActivity.board.PiecesManager
import el.arn.ultimatecheckers.activityWidgets.mainActivity.board.PossibleMovesForTurnBuilder
...
import el.arn.ultimatecheckers.gameCore.game_core.VirtualPlayer
...
class GameCoordinatorImpl(
    ...
    private val gameLogicConfigListener = object :
        ConfigListener {
