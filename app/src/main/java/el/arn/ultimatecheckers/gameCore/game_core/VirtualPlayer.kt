...
package el.arn.ultimatecheckers.gameCore.game_core
...
import el.arn.ultimatecheckers.gameCore.game_core.virtual_player_core.CheckersGameState
import el.arn.ultimatecheckers.gameCore.game_core.virtual_player_core.CheckersMove
import el.arn.ultimatecheckers.gameCore.game_core.virtual_player_core.MinimaxVirtualPlayer
import el.arn.ultimatecheckers.gameCore.game_core.virtual_player_core.MinimaxVirtualPlayerImpl
...
class VirtualPlayerImpl(
    ...
    private class MoveCalculationAsyncTask(
        ...
        val minimaxAgent: MinimaxVirtualPlayer<CheckersMove> =
            MinimaxVirtualPlayerImpl()
