...
import el.arn.ultimatecheckers.gameCore.game_core.checkers_game.implementations.BoardImpl
import el.arn.ultimatecheckers.gameCore.game_core.checkers_game.implementations.GameImpl
import el.arn.ultimatecheckers.gameCore.game_core.checkers_game.implementations.GameLogicConfigImpl
...
import el.arn.ultimatecheckers.gameCore.game_core.VirtualPlayerImpl
    ...
    private fun createNewGame(startingPlayer: Player): GameCoreImpl {
        ...
        val board =
            BoardImpl(
                ...
                appRoot.gamePreferencesManager.startingRows.value
            )
        val game =
            GameImpl(
                gameLogicConfig,
