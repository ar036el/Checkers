...
import el.arn.ultimatecheckers.game.game_core.checkers_game.*;
...
import java.util.*;
import static el.arn.ultimatecheckers.game.game_core.checkers_game.configurations.GameLogicConfig.KingBehaviourOptions.*;
