...
package el.arn.ultimatecheckers.game.game_core.virtual_player_core;

import el.arn.ultimatecheckers.game.game_core.checkers_game.Game;
import el.arn.ultimatecheckers.game.game_core.checkers_game.exceptions.GameException;
...
public class CheckersGameState implements GameState<CheckersMove> {
    ...
    private void createPossibleMoves() {
        for (Tile tile : checkersGame.getAvailablePieces()) {
            for (el.arn.ultimatecheckers.game.game_core.checkers_game.structs.Move checkersMove : checkersGame.getAvailableMovesForPiece(tile.x, tile.y)) {
