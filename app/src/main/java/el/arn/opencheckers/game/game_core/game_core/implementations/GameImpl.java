...
import el.arn.opencheckers.game.game_core.game_core.*;
...
import el.arn.opencheckers.game.game_core.game_core.exceptions.*;
import el.arn.opencheckers.game.game_core.game_core.structs.*;
import java.util.*;
import static el.arn.opencheckers.game.game_core.game_core.configurations.GameLogicConfig.KingBehaviourOptions.*;
